    ...
    <el-container>
      ...
      <el-aside :width="asideWidth" style=" min-height: 100vh; background-color:#001529">
        <div style="height: 60px;color: white; display: flex; align-items: center; justify-content: center">
          ...
          <span class="logo-title" v-show="!isCollapse">你好商家</span>
        </div>
        ...
        <el-menu :collapse="isCollapse" :collapse-transition="false"  router background-color="#001529" text-color="rgba(255,255,255,0.65" active-text-color="#fff" style="border: none" :default-active="$route.path">
          <el-menu-item index="/business_manager/business_home">
          ...
          <el-submenu index="/info">
            ...
            <el-menu-item index="/business_manager/order">订单管理</el-menu-item>
            <el-menu-item index="/business_manager/store">商品管理</el-menu-item>
          </el-submenu>
...
export default {
  ...
  mounted() {
    axios.get('http://172.18.39.191:9090/manager/selectBusinessByPagination',{
      params: {
        page: '',
        pageSize: '',
      }
      ...
      this.business_users = res.data.data.rows;
    })
  },
  methods:{
    handleCollapse(){
